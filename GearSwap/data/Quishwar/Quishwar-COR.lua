...
function init_gear_sets()
    ...
    Artifact_Laksamana = {}
    Artifact_Laksamana.QD_head ="Laksa. Tricorne +1"
    Artifact_Laksamana.RS_WSD_body = "Laksa. Frac +2"
    Artifact_Laksamana.Does_Nothing_hands = "Laksa. Gants"
    Artifact_Laksamana.MAB_legs = "Laksa. Trews +1"
    Artifact_Laksamana.QD_feet = "Laksa. Bottes +1"

    Relic_Lanun = {}
    Relic_Lanun.PRoll_WinningStreak_head = "Lanun Tricorne"
    Relic_Lanun.MAB_RandomDeal_LoadedDeck_body = "Lanun Frac +2"
    Relic_Lanun.Snap_Fold_hands = "Lanun Gants"
    Relic_Lanun.Snap_SnakeEye_legs = "Lanun Trews"
    Relic_Lanun.WildCard_feet = "Lanun Bottes +1"

    Empyrean_Chaussers = {}
    Empyrean_Chaussers.RS_Blitzers_head = "Chass. Tricorne"
    Empyrean_Chaussers.TripleShot_body = "Navarch's Frac +1"
    Empyrean_Chaussers.PRoll_hands = "Chass. Gants +1"
    Empyrean_Chaussers.No_Legs = ""
    Empyrean_Chaussers.EnhancesQD_feet = "Navarch's Bottes +1"

    Cumulus_Mantle = {}
    Cumulus_Mantle.WS = {
        name="Camulus's Mantle",
        augments={'STR+20','Accuracy+20 Attack+20',
        'STR+10',
    ...
    sets.precast.JA['Snake Eye'] = Relic_Lanun.Snap_SnakeEye_legs
    sets.precast.JA['Wild Card'] = Relic_Lanun.WildCard_feet
    sets.precast.JA['Random Deal'] = Relic_Lanun.MAB_RandomDeal_LoadedDeck_body

    sets.precast.CorsairRoll = {
        head=Relic_Lanun.PRoll_WinningStreak_head,
        hands=Empyrean_Chaussers.PRoll_hands,
    ...
    sets.precast.CorsairRoll["Courser's Roll"] = set_combine(sets.precast.CorsairRoll, {feet=Empyrean_Chaussers.EnhancesQD_feet})
    sets.precast.CorsairRoll["Blitzer's Roll"] = set_combine(sets.precast.CorsairRoll, {head=Empyrean_Chaussers.RS_Blitzers_head})
    sets.precast.CorsairRoll["Tactician's Roll"] = set_combine(sets.precast.CorsairRoll, {body=Empyrean_Chaussers.TripleShot_body})
    sets.precast.CorsairRoll["Allies' Roll"] = set_combine(sets.precast.CorsairRoll, {hands=Empyrean_Chaussers.PRoll_hands})

    sets.precast.LuzafRing = {ring1="Luzaf's Ring"}
    sets.precast.FoldDoubleBust = Relic_Lanun.Snap_Fold_hands
    ...
    sets.precast.RA = {
        ammo=gear.RAbullet,
        head=Empyrean_Chaussers.RS_Blitzers_head, --0/16
        body="Oshosi Vest +1", --14/0
        hands=gear.Carmine_hands, --8/11
        legs=gear.Meghanada_Ambuscade_legs, --10/13
        feet=gear.Meghanada_Ambuscade_feet, --10/0
        neck="Ocachi Gorget", --4/0
    ...
    sets.precast.RA.Flurry1 = set_combine(sets.precast.RA, {
        body=Artifact_Laksamana.RS_WSD_body, --0/20
    ...
    sets.precast.WS = {
        ...
        body=Artifact_Laksamana.RS_WSD_body,
        ...
        ring1="Dingir Ring",
        ring2="Refuscent Ring",
        back=Cumulus_Mantle.WS,
    ...
    sets.precast.WS['Wildfire'] = {
        ...
        body=Relic_Lanun.MAB_RandomDeal_LoadedDeck_body,
    ...
    sets.precast.WS['Requiescat'] = set_combine(sets.precast.WS['Swift Blade'], {
        hands=gear.Meghanada_Ambuscade_hands,
        ear1=gear.Moonshade_Earring,
        ear2="Telos Earring",
