...
function define_global_sets()
    ...
    -- Herc set
    gear.Herc_WSD_head = {name="Herculean Helm", augments={'Attack+30','Weapon skill damage +3%','STR+5','Accuracy+9'}}
    gear.Herc_WS_MAB_hands = {name="Herculean Gloves", augments={'"Mag.Atk.Bns."+5','Weapon skill damage +5%','INT+9'}}
    gear.Herc_TA_hands = {name="Herculean Gloves", augments={'Accuracy+20','"Triple Atk."+3','AGI+6'}}
    gear.Herc_TH_legs = {name="Herculean Trousers", augments={'Pet: STR+1','Rng.Atk.+2','"Treasure Hunter"+2','Accuracy+10 Attack+10'}}
    gear.Herc_WSD_legs = {name="Herculean Trousers", augments={'Mag. Acc.+17','Weapon skill damage +4%','INT+3','"Mag.Atk.Bns."+10'}}
    gear.Herc_QA_feet = {name="Herculean Boots", augments={'Rng.Atk.+24','Rng.Acc.+1','Quadruple Attack +3'}}
    gear.Herc_MAB_feet = {name="Herculean Boots", augments={'Attack+29','Accuracy+24','INT+4 MND+4 CHR+4','Mag. Acc.+19 "Mag.Atk.Bns."+19'}}


    -- Samnuha augs?
    gear.Samnuha_DW_body={name="Samnuha Coat", augments={'Mag. Acc.+3','"Dual Wield"+4',}}
